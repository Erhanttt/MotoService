<x-app-layout>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
                <div class="px-6 py-8 sm:px-10 sm:py-10">
                    <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input 
                                        ...
                                        type="text" 
                                        value="{{ old('name') }}" 
                                        placeholder="ex. moto - name ( parts name )" 
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center justify-center w-full">
                                        <label for="image" class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-xl cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors duration-200 group">
                                            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                                <svg class="w-8 h-8 mb-4 text-gray-500 group-hover:text-yellow-500 transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- Action Buttons -->
                        <div class="flex flex-col sm:flex-row justify-end gap-4 pt-8 mt-8 border-t border-gray-200">
                            <a 
                                href="{{ url()->previous() }}" 
                                class="inline-flex items-center justify-center px-6 py-3 border-2 border-gray-300 text-sm font-semibold rounded-xl text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200"
                            >
            ...
            <div class="mt-8 bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-6 border border-green-200">
                <div class="flex items-start">
                    ...
                    <div class="ml-4">
                        <h3 class="text-lg font-bold text-green-800 mb-2">Create New Product</h3>
                        <p class="text-green-700 text-sm leading-relaxed">
                            Add a new product to your inventory. Fill in all the required details including name, price, category, 
                            and a clear image. A good description helps customers understand your product better and improves 
                            your sales potential.
                        </p>
                        <ul class="mt-3 text-green-700 text-sm space-y-1">
                            ...
                            <li class="flex items-center">
                                ...
                                Choose the most relevant category for easy discovery
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <script>
        // Optional: Add file upload preview functionality
        document.getElementById('image').addEventListener('change', function(e) {
            ...
            if (file) {
                ...
                preview.innerHTML = `
                    <div class="inline-flex items-center text-sm text-green-600 bg-green-50 px-3 py-1 rounded-full">
                ...
                const existingPreview = label.querySelector('.mt-2');
                if (existingPreview) {
